                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#pill-justified-beneficiario-1" role="tab">
                                            BENEFICIARIO    
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#terceros" role="tab">
                                            TERCEROS
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#pill-justified-expuestas-1" role="tab">
                                            P.EXPUESTAS
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#pill-justified-jurada-1" role="tab">
                                            D. JURADA
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#pill-justified-adjuntar-1" role="tab">
                                            ADJUNTAR
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#pill-justified-interno-1" role="tab">
                                            USO INTERNO
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#pill-justified-aviso-1" role="tab">
                                            AVISO LEGAL
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <form method="POST" action="" enctype="multipart/form-data">
                                    <div class="tab-content text-muted">
                                            ...
                                            <div class="tab-pane" id="pill-justified-beneficiario-1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header align-items-center d-flex">
                                            ...
                                            <div class="tab-pane" id="pill-justified-expuestas-1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header align-items-center d-flex">
                                            ...
                                            <div class="tab-pane" id="pill-justified-jurada-1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header align-items-center d-flex">
                                            ...
                                            <div class="tab-pane" id="pill-justified-adjuntar-1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header align-items-center d-flex">
                                                                    ...
                                                                    <div class="row gy-4">
                                                                        ...
                                                                        <div class="col-xxl-6 col-md-6">
                                                                            <div>
                                                                                ...
                                                                                <input type="file" class="form-control" id="basiInput" name="fo_aviso_operaciones">
                                                                            </div>
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-xxl-6 col-md-6">                                                           
                                            ...
                                            <div class="tab-pane" id="pill-justified-interno-1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header align-items-center d-flex">
                                            ...
                                            <div class="tab-pane" id="pill-justified-aviso-1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header align-items-center d-flex">
